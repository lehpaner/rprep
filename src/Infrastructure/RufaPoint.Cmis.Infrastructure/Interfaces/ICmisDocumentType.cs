...
{
	/// <summary>
	/// CMIS document object-type. Document objects are the elementary information entities managed by the repository.
	/// </summary>
    public interface ICmisDocumentType : ICmisObjectType
    {
		/// <summary>
