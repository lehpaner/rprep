...
namespace RufaPoint.Resilience.Http
{
    public class SafeHttpClient : IHttpClient
    {
        ...
        public SafeHttpClient(Func<string, IEnumerable<Policy>> policyCreator, ILogger<SafeHttpClient> logger, IHttpContextAccessor httpContextAccessor)
        {
