...
using RufaPoint.Web.Areas.Admin.Models.Logging;
using RufaPoint.Web.Areas.Admin.Models.Messages;
using RufaPoint.Web.Areas.Admin.Models.News;
using RufaPoint.Web.Areas.Admin.Models.Orders;
using RufaPoint.Web.Areas.Admin.Models.Payments;
...
using RufaPoint.Web.Areas.Admin.Models.Topics;
...
using RufaPoint.Services.Shipping.Pickup;
using RufaPoint.Services.Tax;
using RufaPoint.Web.Framework.Security.Captcha;

namespace RufaPoint.Web.Areas.Admin.Extensions
{
    public static class MappingExtensions
    {
        ...
        {
            //this method is very similar to the same one in RufaPoint.Web project
