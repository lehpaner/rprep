...
namespace RufaPoint.Web.Infrastructure.Cache
{
    /// <summary>
        ...
        IConsumer<EntityUpdated<ShoppingCartItem>>
    {
        ...
        /// {2} : current store ID
        /// </remarks>
        public const string SEARCH_CATEGORIES_MODEL_KEY = "RufaPoint.pres.search.categories-{0}-{1}-{2}";
        public const string SEARCH_CATEGORIES_PATTERN_KEY = "RufaPoint.pres.search.categories";
        ...
        /// {3} : current store ID
        /// </remarks>
        public const string MANUFACTURER_NAVIGATION_MODEL_KEY = "RufaPoint.pres.manufacturer.navigation-{0}-{1}-{2}-{3}";
        public const string MANUFACTURER_NAVIGATION_PATTERN_KEY = "RufaPoint.pres.manufacturer.navigation";

        /// <summary>
        /// Key for VendorNavigationModel caching
        /// </summary>
        public const string VENDOR_NAVIGATION_MODEL_KEY = "RufaPoint.pres.vendor.navigation";
        public const string VENDOR_NAVIGATION_PATTERN_KEY = "RufaPoint.pres.vendor.navigation";
        ...
        /// {2} : current store ID
        /// </remarks>
        public const string MANUFACTURER_HAS_FEATURED_PRODUCTS_KEY = "RufaPoint.pres.manufacturer.hasfeaturedproducts-{0}-{1}-{2}";
        public const string MANUFACTURER_HAS_FEATURED_PRODUCTS_PATTERN_KEY = "RufaPoint.pres.manufacturer.hasfeaturedproducts";
        public const string MANUFACTURER_HAS_FEATURED_PRODUCTS_PATTERN_KEY_BY_ID = "RufaPoint.pres.manufacturer.hasfeaturedproducts-{0}-";
        ...
        /// {2} : current store ID
        /// </remarks>
        public const string CATEGORY_ALL_MODEL_KEY = "RufaPoint.pres.category.all-{0}-{1}-{2}";
        public const string CATEGORY_ALL_PATTERN_KEY = "RufaPoint.pres.category.all";
        ...
        /// {2} : category ID
        /// </remarks>
        public const string CATEGORY_NUMBER_OF_PRODUCTS_MODEL_KEY = "RufaPoint.pres.category.numberofproducts-{0}-{1}-{2}";
        public const string CATEGORY_NUMBER_OF_PRODUCTS_PATTERN_KEY = "RufaPoint.pres.category.numberofproducts";
        ...
        /// {2} : current store ID
        /// </remarks>
        public const string CATEGORY_HAS_FEATURED_PRODUCTS_KEY = "RufaPoint.pres.category.hasfeaturedproducts-{0}-{1}-{2}";
        public const string CATEGORY_HAS_FEATURED_PRODUCTS_PATTERN_KEY = "RufaPoint.pres.category.hasfeaturedproducts";
        public const string CATEGORY_HAS_FEATURED_PRODUCTS_PATTERN_KEY_BY_ID = "RufaPoint.pres.category.hasfeaturedproducts-{0}-";
        ...
        /// {3} : language ID
        /// </remarks>
        public const string CATEGORY_BREADCRUMB_KEY = "RufaPoint.pres.category.breadcrumb-{0}-{1}-{2}-{3}";
        public const string CATEGORY_BREADCRUMB_PATTERN_KEY = "RufaPoint.pres.category.breadcrumb";
        ...
        /// </remarks>
        public const string CATEGORY_SUBCATEGORIES_KEY = "RufaPoint.pres.category.subcategories-{0}-{1}-{2}-{3}-{4}-{5}";
        public const string CATEGORY_SUBCATEGORIES_PATTERN_KEY = "RufaPoint.pres.category.subcategories";
        ...
        /// </remarks>
        public const string CATEGORY_HOMEPAGE_KEY = "RufaPoint.pres.category.homepage-{0}-{1}-{2}-{3}-{4}";
        public const string CATEGORY_HOMEPAGE_PATTERN_KEY = "RufaPoint.pres.category.homepage";
        ...
        /// {2} : current store ID
        /// </remarks>
        public const string CATEGORY_CHILD_IDENTIFIERS_MODEL_KEY = "RufaPoint.pres.category.childidentifiers-{0}-{1}-{2}";
        public const string CATEGORY_CHILD_IDENTIFIERS_PATTERN_KEY = "RufaPoint.pres.category.childidentifiers";
        ...
        /// {1} : language id
        /// </remarks>
        public const string SPECS_FILTER_MODEL_KEY = "RufaPoint.pres.filter.specs-{0}-{1}";
        public const string SPECS_FILTER_PATTERN_KEY = "RufaPoint.pres.filter.specs";
        ...
        /// {3} : current store ID
        /// </remarks>
        public const string PRODUCT_BREADCRUMB_MODEL_KEY = "RufaPoint.pres.product.breadcrumb-{0}-{1}-{2}-{3}";
        public const string PRODUCT_BREADCRUMB_PATTERN_KEY = "RufaPoint.pres.product.breadcrumb";
        public const string PRODUCT_BREADCRUMB_PATTERN_KEY_BY_ID = "RufaPoint.pres.product.breadcrumb-{0}-";
        ...
        /// {2} : current store ID
        /// </remarks>
        public const string PRODUCTTAG_BY_PRODUCT_MODEL_KEY = "RufaPoint.pres.producttag.byproduct-{0}-{1}-{2}";
        public const string PRODUCTTAG_BY_PRODUCT_PATTERN_KEY = "RufaPoint.pres.producttag.byproduct";
        ...
        /// {1} : current store ID
        /// </remarks>
        public const string PRODUCTTAG_POPULAR_MODEL_KEY = "RufaPoint.pres.producttag.popular-{0}-{1}";
        public const string PRODUCTTAG_POPULAR_PATTERN_KEY = "RufaPoint.pres.producttag.popular";
        ...
        /// {3} : current store ID
        /// </remarks>
        public const string PRODUCT_MANUFACTURERS_MODEL_KEY = "RufaPoint.pres.product.manufacturers-{0}-{1}-{2}-{3}";
        public const string PRODUCT_MANUFACTURERS_PATTERN_KEY = "RufaPoint.pres.product.manufacturers";
        public const string PRODUCT_MANUFACTURERS_PATTERN_KEY_BY_ID = "RufaPoint.pres.product.manufacturers-{0}-";
        ...
        /// {1} : language id
        /// </remarks>
        public const string PRODUCT_SPECS_MODEL_KEY = "RufaPoint.pres.product.specs-{0}-{1}";
        public const string PRODUCT_SPECS_PATTERN_KEY = "RufaPoint.pres.product.specs";
        public const string PRODUCT_SPECS_PATTERN_KEY_BY_ID = "RufaPoint.pres.product.specs-{0}-";
        ...
        /// {0} : product id
        /// </remarks>
        public const string PRODUCT_HAS_PRODUCT_ATTRIBUTES_KEY = "RufaPoint.pres.product.hasproductattributes-{0}-";
        public const string PRODUCT_HAS_PRODUCT_ATTRIBUTES_PATTERN_KEY = "RufaPoint.pres.product.hasproductattributes";
        public const string PRODUCT_HAS_PRODUCT_ATTRIBUTES_PATTERN_KEY_BY_ID = "RufaPoint.pres.product.hasproductattributes-{0}-";
        ...
        /// </remarks>
        public const string TOPIC_MODEL_BY_SYSTEMNAME_KEY = "RufaPoint.pres.topic.details.bysystemname-{0}-{1}-{2}-{3}";
        /// <summary>
        /// Key for TopicModel caching
        /// </summary>
        /// <remarks>
        ...
        /// {3} : comma separated list of customer roles
        /// </remarks>
        public const string TOPIC_MODEL_BY_ID_KEY = "RufaPoint.pres.topic.details.byid-{0}-{1}-{2}-{3}";
        /// <summary>
        /// Key for TopicModel caching
        /// </summary>
        /// <remarks>
        ...
        /// {2} : store id
        /// </remarks>
        public const string TOPIC_SENAME_BY_SYSTEMNAME = "RufaPoint.pres.topic.sename.bysystemname-{0}-{1}-{2}";
        /// <summary>
        /// Key for TopicModel caching
        /// </summary>
        /// <remarks>
        ...
        /// {2} : store id
        /// </remarks>
        public const string TOPIC_TITLE_BY_SYSTEMNAME = "RufaPoint.pres.topic.title.bysystemname-{0}-{1}-{2}";
        /// <summary>
        ...
        /// {2} : comma separated list of customer roles
        /// </remarks>
        public const string TOPIC_TOP_MENU_MODEL_KEY = "RufaPoint.pres.topic.topmenu-{0}-{1}-{2}";
        /// <summary>
        /// Key for TopMenuModel caching
        /// </summary>
        /// <remarks>
        ...
        /// {2} : comma separated list of customer roles
        /// </remarks>
        public const string TOPIC_FOOTER_MODEL_KEY = "RufaPoint.pres.topic.footer-{0}-{1}-{2}";
        public const string TOPIC_PATTERN_KEY = "RufaPoint.pres.topic";
        ...
        /// </remarks>
        public const string CATEGORY_TEMPLATE_MODEL_KEY = "RufaPoint.pres.categorytemplate-{0}";
        public const string CATEGORY_TEMPLATE_PATTERN_KEY = "RufaPoint.pres.categorytemplate";
        ...
        /// </remarks>
        public const string MANUFACTURER_TEMPLATE_MODEL_KEY = "RufaPoint.pres.manufacturertemplate-{0}";
        public const string MANUFACTURER_TEMPLATE_PATTERN_KEY = "RufaPoint.pres.manufacturertemplate";
        ...
        /// </remarks>
        public const string PRODUCT_TEMPLATE_MODEL_KEY = "RufaPoint.pres.producttemplate-{0}";
        public const string PRODUCT_TEMPLATE_PATTERN_KEY = "RufaPoint.pres.producttemplate";
        ...
        /// {0} : topic template id
        /// </remarks>
        public const string TOPIC_TEMPLATE_MODEL_KEY = "RufaPoint.pres.topictemplate-{0}";
        public const string TOPIC_TEMPLATE_PATTERN_KEY = "RufaPoint.pres.topictemplate";
        ...
        /// {0} : current store ID
        /// </remarks>
        public const string HOMEPAGE_BESTSELLERS_IDS_KEY = "RufaPoint.pres.bestsellers.homepage-{0}";
        public const string HOMEPAGE_BESTSELLERS_IDS_PATTERN_KEY = "RufaPoint.pres.bestsellers.homepage";
        ...
        /// {1} : current store ID
        /// </remarks>
        public const string PRODUCTS_ALSO_PURCHASED_IDS_KEY = "RufaPoint.pres.alsopuchased-{0}-{1}";
        public const string PRODUCTS_ALSO_PURCHASED_IDS_PATTERN_KEY = "RufaPoint.pres.alsopuchased";
        ...
        /// {1} : current store ID
        /// </remarks>
        public const string PRODUCTS_RELATED_IDS_KEY = "RufaPoint.pres.related-{0}-{1}";
        public const string PRODUCTS_RELATED_IDS_PATTERN_KEY = "RufaPoint.pres.related";
        ...
        /// {5} : current store ID
        /// </remarks>
        public const string PRODUCT_DEFAULTPICTURE_MODEL_KEY = "RufaPoint.pres.product.detailspictures-{0}-{1}-{2}-{3}-{4}-{5}";
        public const string PRODUCT_DEFAULTPICTURE_PATTERN_KEY = "RufaPoint.pres.product.detailspictures";
        public const string PRODUCT_DEFAULTPICTURE_PATTERN_KEY_BY_ID = "RufaPoint.pres.product.detailspictures-{0}-";
        ...
        /// {5} : current store ID
        /// </remarks>
        public const string PRODUCT_DETAILS_PICTURES_MODEL_KEY = "RufaPoint.pres.product.picture-{0}-{1}-{2}-{3}-{4}-{5}";
        public const string PRODUCT_DETAILS_PICTURES_PATTERN_KEY = "RufaPoint.pres.product.picture";
        public const string PRODUCT_DETAILS_PICTURES_PATTERN_KEY_BY_ID = "RufaPoint.pres.product.picture-{0}-";
        ...
        /// {1} : current store ID
        /// </remarks>
        public const string PRODUCT_REVIEWS_MODEL_KEY = "RufaPoint.pres.product.reviews-{0}-{1}";
        public const string PRODUCT_REVIEWS_PATTERN_KEY = "RufaPoint.pres.product.reviews";
        public const string PRODUCT_REVIEWS_PATTERN_KEY_BY_ID = "RufaPoint.pres.product.reviews-{0}-";
        ...
        /// {2} : current store ID
        /// </remarks>
        public const string PRODUCTATTRIBUTE_PICTURE_MODEL_KEY = "RufaPoint.pres.productattribute.picture-{0}-{1}-{2}";
        public const string PRODUCTATTRIBUTE_PICTURE_PATTERN_KEY = "RufaPoint.pres.productattribute.picture";
        ...
        /// {2} : current store ID
        /// </remarks>
        public const string PRODUCTATTRIBUTE_IMAGESQUARE_PICTURE_MODEL_KEY = "RufaPoint.pres.productattribute.imagesquare.picture-{0}-{1}-{2}";
        public const string PRODUCTATTRIBUTE_IMAGESQUARE_PICTURE_PATTERN_KEY = "RufaPoint.pres.productattribute.imagesquare.picture";
        ...
        /// {5} : current store ID
        /// </remarks>
        public const string CATEGORY_PICTURE_MODEL_KEY = "RufaPoint.pres.category.picture-{0}-{1}-{2}-{3}-{4}-{5}";
        public const string CATEGORY_PICTURE_PATTERN_KEY = "RufaPoint.pres.category.picture";
        public const string CATEGORY_PICTURE_PATTERN_KEY_BY_ID = "RufaPoint.pres.category.picture-{0}-";
        ...
        /// {5} : current store ID
        /// </remarks>
        public const string MANUFACTURER_PICTURE_MODEL_KEY = "RufaPoint.pres.manufacturer.picture-{0}-{1}-{2}-{3}-{4}-{5}";
        public const string MANUFACTURER_PICTURE_PATTERN_KEY = "RufaPoint.pres.manufacturer.picture";
        public const string MANUFACTURER_PICTURE_PATTERN_KEY_BY_ID = "RufaPoint.pres.manufacturer.picture-{0}-";
        ...
        /// {5} : current store ID
        /// </remarks>
        public const string VENDOR_PICTURE_MODEL_KEY = "RufaPoint.pres.vendor.picture-{0}-{1}-{2}-{3}-{4}-{5}";
        public const string VENDOR_PICTURE_PATTERN_KEY = "RufaPoint.pres.vendor.picture";
        public const string VENDOR_PICTURE_PATTERN_KEY_BY_ID = "RufaPoint.pres.vendor.picture-{0}-";
        ...
        /// {5} : current store ID
        /// </remarks>
        public const string CART_PICTURE_MODEL_KEY = "RufaPoint.pres.cart.picture-{0}-{1}-{2}-{3}-{4}-{5}";
        public const string CART_PICTURE_PATTERN_KEY = "RufaPoint.pres.cart.picture";
        ...
        /// {0} : language ID
        /// </remarks>
        public const string HOMEPAGE_POLLS_MODEL_KEY = "RufaPoint.pres.poll.homepage-{0}";
        /// <summary>
        ...
        /// {1} : language ID
        /// </remarks>
        public const string POLL_BY_SYSTEMNAME_MODEL_KEY = "RufaPoint.pres.poll.systemname-{0}-{1}";
        public const string POLLS_PATTERN_KEY = "RufaPoint.pres.poll";
        ...
        /// {1} : current store ID
        /// </remarks>
        public const string BLOG_TAGS_MODEL_KEY = "RufaPoint.pres.blog.tags-{0}-{1}";
        /// <summary>
        ...
        /// {1} : current store ID
        /// </remarks>
        public const string BLOG_MONTHS_MODEL_KEY = "RufaPoint.pres.blog.months-{0}-{1}";
        public const string BLOG_PATTERN_KEY = "RufaPoint.pres.blog";
        /// <summary>
        ...
        /// </remarks>
        public const string BLOG_COMMENTS_NUMBER_KEY = "RufaPoint.pres.blog.comments.number-{0}-{1}-{2}";
        public const string BLOG_COMMENTS_PATTERN_KEY = "RufaPoint.pres.blog.comments";
        ...
        /// {1} : current store ID
        /// </remarks>
        public const string HOMEPAGE_NEWSMODEL_KEY = "RufaPoint.pres.news.homepage-{0}-{1}";
        public const string NEWS_PATTERN_KEY = "RufaPoint.pres.news";
        /// <summary>
        ...
        /// {2} : are only approved comments?
        /// </remarks>
        public const string NEWS_COMMENTS_NUMBER_KEY = "RufaPoint.pres.news.comments.number-{0}-{1}-{2}";
        public const string NEWS_COMMENTS_PATTERN_KEY = "RufaPoint.pres.news.comments";
        ...
        /// {2} : language ID
        /// </remarks>
        public const string STATEPROVINCES_BY_COUNTRY_MODEL_KEY = "RufaPoint.pres.stateprovinces.bycountry-{0}-{1}-{2}";
        public const string STATEPROVINCES_PATTERN_KEY = "RufaPoint.pres.stateprovinces";
        ...
        /// {0} : language ID
        /// </remarks>
        public const string RETURNREQUESTREASONS_MODEL_KEY = "RufaPoint.pres.returnrequesreasons-{0}";
        public const string RETURNREQUESTREASONS_PATTERN_KEY = "RufaPoint.pres.returnrequesreasons";
        ...
        /// {0} : language ID
        /// </remarks>
        public const string RETURNREQUESTACTIONS_MODEL_KEY = "RufaPoint.pres.returnrequestactions-{0}";
        public const string RETURNREQUESTACTIONS_PATTERN_KEY = "RufaPoint.pres.returnrequestactions";
        ...
        /// </remarks>
        public const string STORE_LOGO_PATH = "RufaPoint.pres.logo-{0}-{1}-{2}";
        public const string STORE_LOGO_PATH_PATTERN_KEY = "RufaPoint.pres.logo";
        ...
        /// {0} : current store ID
        /// </remarks>
        public const string AVAILABLE_LANGUAGES_MODEL_KEY = "RufaPoint.pres.languages.all-{0}";
        public const string AVAILABLE_LANGUAGES_PATTERN_KEY = "RufaPoint.pres.languages";
        ...
        /// {1} : current store ID
        /// </remarks>
        public const string AVAILABLE_CURRENCIES_MODEL_KEY = "RufaPoint.pres.currencies.all-{0}-{1}";
        public const string AVAILABLE_CURRENCIES_PATTERN_KEY = "RufaPoint.pres.currencies";
        ...
        /// </remarks>
        public const string CHECKOUTATTRIBUTES_EXIST_KEY = "RufaPoint.pres.checkoutattributes.exist-{0}-{1}";
        public const string CHECKOUTATTRIBUTES_PATTERN_KEY = "RufaPoint.pres.checkoutattributes";
        ...
        /// {2} : current store ID
        /// </remarks>
        public const string SITEMAP_PAGE_MODEL_KEY = "RufaPoint.pres.sitemap.page-{0}-{1}-{2}";
        /// <summary>
        ...
        /// {3} : current store ID
        /// </remarks>
        public const string SITEMAP_SEO_MODEL_KEY = "RufaPoint.pres.sitemap.seo-{0}-{1}-{2}-{3}";
        public const string SITEMAP_PATTERN_KEY = "RufaPoint.pres.sitemap";
        ...
        /// </remarks>
        public const string WIDGET_MODEL_KEY = "RufaPoint.pres.widget-{0}-{1}-{2}-{3}";
        public const string WIDGET_PATTERN_KEY = "RufaPoint.pres.widget";
