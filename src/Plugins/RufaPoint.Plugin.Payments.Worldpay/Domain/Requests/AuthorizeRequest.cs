...
{
    /// <summary>
    /// Represents request parameters to authorize a transaction.
    /// </summary>
    public class AuthorizeRequest : WorldpayPaymentRequest
    {
        #region Ctor

        public AuthorizeRequest(ChargeRequest request)
        {
            AddToVault = request.AddToVault;
            AddToVaultOnFailure = request.AddToVaultOnFailure;
            AllowPartialChanges = request.AllowPartialChanges;
            Amount = request.Amount;
            Card = request.Card;
            ExtendedInformation = request.ExtendedInformation;
            OrderId = request.OrderId;
            PaymentVaultToken = request.PaymentVaultToken;
            TransactionDuplicateCheckType = request.TransactionDuplicateCheckType;
            VisaCheckoutData = request.VisaCheckoutData;
        }
        ...
        /// </summary>
        /// <returns>URL</returns>
        public override string GetRequestUrl() => "api/Payments/Authorize";
