...
using RufaPoint.Plugin.Payments.Worldpay.Domain;
using RufaPoint.Plugin.Payments.Worldpay.Domain.Enums;
using RufaPoint.Plugin.Payments.Worldpay.Domain.Models;
using RufaPoint.Plugin.Payments.Worldpay.Domain.Requests;
...
namespace RufaPoint.Plugin.Payments.Worldpay
{
    /// <summary>
    ...
    public class WorldpayPaymentMethod : BasePlugin, IPaymentMethod
    {
        ...
        public override void Install()
        {
            ...
            //locales
            this.AddOrUpdatePluginLocaleResource("Enums.RufaPoint.Plugin.Payments.Worldpay.Domain.Enums.CreditCardType.AMEX", "AMEX");
            this.AddOrUpdatePluginLocaleResource("Enums.RufaPoint.Plugin.Payments.Worldpay.Domain.Enums.CreditCardType.Discover", "DISCOVER");
            this.AddOrUpdatePluginLocaleResource("Enums.RufaPoint.Plugin.Payments.Worldpay.Domain.Enums.CreditCardType.MasterCard", "MasterCard");
            this.AddOrUpdatePluginLocaleResource("Enums.RufaPoint.Plugin.Payments.Worldpay.Domain.Enums.CreditCardType.MasterCardFleet", "MasterCard Fleet");
            this.AddOrUpdatePluginLocaleResource("Enums.RufaPoint.Plugin.Payments.Worldpay.Domain.Enums.CreditCardType.Visa", "VISA");
            this.AddOrUpdatePluginLocaleResource("Enums.RufaPoint.Plugin.Payments.Worldpay.Domain.Enums.CreditCardType.VisaFleet", "VISA Fleet");
            this.AddOrUpdatePluginLocaleResource("Enums.RufaPoint.Plugin.Payments.Worldpay.Domain.TransactionMode.Authorize", "Authorize only");
            this.AddOrUpdatePluginLocaleResource("Enums.RufaPoint.Plugin.Payments.Worldpay.Domain.TransactionMode.Charge", "Charge (authorize and capture)");
        ...
        public override void Uninstall()
        {
            ...
            //locales
            this.DeletePluginLocaleResource("Enums.RufaPoint.Plugin.Payments.Worldpay.Domain.Enums.CreditCardType.AMEX");
            this.DeletePluginLocaleResource("Enums.RufaPoint.Plugin.Payments.Worldpay.Domain.Enums.CreditCardType.Discover");
            this.DeletePluginLocaleResource("Enums.RufaPoint.Plugin.Payments.Worldpay.Domain.Enums.CreditCardType.MasterCard");
            this.DeletePluginLocaleResource("Enums.RufaPoint.Plugin.Payments.Worldpay.Domain.Enums.CreditCardType.MasterCardFleet");
            this.DeletePluginLocaleResource("Enums.RufaPoint.Plugin.Payments.Worldpay.Domain.Enums.CreditCardType.Visa");
            this.DeletePluginLocaleResource("Enums.RufaPoint.Plugin.Payments.Worldpay.Domain.Enums.CreditCardType.VisaFleet");
            this.DeletePluginLocaleResource("Enums.RufaPoint.Plugin.Payments.Worldpay.Domain.TransactionMode.Authorize");
            this.DeletePluginLocaleResource("Enums.RufaPoint.Plugin.Payments.Worldpay.Domain.TransactionMode.Charge");
        ...
        /// </summary>
        public RufaPoint.Services.Payments.PaymentMethodType PaymentMethodType
        {
            get { return RufaPoint.Services.Payments.PaymentMethodType.Standard; }
        }
