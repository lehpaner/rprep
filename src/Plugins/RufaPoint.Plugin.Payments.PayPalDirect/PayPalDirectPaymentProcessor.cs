...
using RufaPoint.Plugin.Payments.PayPalDirect.Models;
using RufaPoint.Plugin.Payments.PayPalDirect.Validators;
...
namespace RufaPoint.Plugin.Payments.PayPalDirect
{
    /// <summary>
