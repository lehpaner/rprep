...
namespace RufaPoint.Plugin.Shipping.FixedOrByWeight.Services
{
    /// <summary>
    ...
    public partial class ShippingByWeightService : IShippingByWeightService
    {
        ...
        /// {1} : page size
        /// </remarks>
        private const string SHIPPINGBYWEIGHT_ALL_KEY = "RufaPoint.shippingbyweight.all-{0}-{1}";
        private const string SHIPPINGBYWEIGHT_PATTERN_KEY = "RufaPoint.shippingbyweight.";
