...
namespace RufaPoint.Plugin.Payments.Square
{
    ...
    public class SquarePaymentMethod : BasePlugin, IPaymentMethod
    {
        ...
        public override void Install()
        {
            ...
            //locales
            this.AddOrUpdatePluginLocaleResource("Enums.RufaPoint.Plugin.Payments.Square.Domain.TransactionMode.Authorize", "Authorize only");
            this.AddOrUpdatePluginLocaleResource("Enums.RufaPoint.Plugin.Payments.Square.Domain.TransactionMode.Charge", "Charge (authorize and capture)");
        ...
        public override void Uninstall()
        {
            ...
            //locales
            this.DeletePluginLocaleResource("Enums.RufaPoint.Plugin.Payments.Square.Domain.TransactionMode.Authorize");
            this.DeletePluginLocaleResource("Enums.RufaPoint.Plugin.Payments.Square.Domain.TransactionMode.Charge");
