...
namespace RufaPoint.Plugin.Payments.Square
{
    ...
    public static class SquarePaymentDefaults
    {
        ...
        /// </summary>
        public static string UserAgent => "Square-connect-rufaPoint-1.0";
        ...
        /// </summary>
        public static string RenewAccessTokenTask => "RufaPoint.Plugin.Payments.Square.Services.RenewAccessTokenTask";
