...
namespace RufaPoint.Plugin.Tax.FixedOrByCountryStateZip.Infrastructure.Cache
{
    /// <summary>
        ...
        IConsumer<EntityDeleted<TaxCategory>>
    {
        ...
        /// </summary>
        public const string ALL_TAX_RATES_MODEL_KEY = "RufaPoint.plugins.tax.fixedorbycountrystateziptaxrate.all";
        public const string TAXRATE_ALL_KEY = "RufaPoint.plugins.tax.fixedorbycountrystateziptaxrate.all-{0}-{1}";
        public const string TAXRATE_PATTERN_KEY = "RufaPoint.plugins.tax.fixedorbycountrystateziptaxrate.";
