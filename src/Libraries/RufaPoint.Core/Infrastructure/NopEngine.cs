...
namespace RufaPoint.Core.Infrastructure
{
    ...
    public class NopEngine : IEngine
    {
        ...
        /// <param name="typeFinder">Type finder</param>
        protected virtual IServiceProvider RegisterDependencies(RufaPointConfig nopConfig, IServiceCollection services, ITypeFinder typeFinder)
        {
        ...
        public void Initialize(IServiceCollection services)
        {
            ...
            var nopConfig = provider.GetRequiredService<RufaPointConfig>();
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services, IConfigurationRoot configuration)
        {
            ...
            var nopConfig = services.BuildServiceProvider().GetService<RufaPointConfig>();
