...
using RufaPoint.Core.Domain.Cms;
...
namespace RufaPoint.Services.Installation
{
    /// <summary>
    ...
    public partial class CodeFirstInstallationService : IInstallationService
    {
        ...
        protected virtual void InstallCustomersAndUsers(string defaultUserEmail, string defaultUserPassword)
        {
            ...
            var defaultAdminUserAddress = new Address
            {
                ...
                Email = defaultUserEmail,
                FaxNumber = "",
                Company = "RufaPoint Solutions Ltd",
        ...
        protected virtual void InstallScheduleTasks()
        {
            var tasks = new List<ScheduleTask>
            {
                new ScheduleTask
                {
                    Name = "Send emails",
                    Seconds = 60,
                    Type = "RufaPoint.Services.Messages.QueuedMessagesSendTask, RufaPoint.Services",
                    Enabled = true,
                    StopOnError = false,
                },
                new ScheduleTask
                {
                    Name = "Keep alive",
                    Seconds = 300,
                    Type = "RufaPoint.Services.Common.KeepAliveTask, RufaPoint.Services",
                    Enabled = true,
                    StopOnError = false,
                },
                new ScheduleTask
                {
                    Name = "Delete guests",
                    Seconds = 600,
                    Type = "RufaPoint.Services.Customers.DeleteGuestsTask, RufaPoint.Services",
                    Enabled = true,
                    StopOnError = false,
                },
                new ScheduleTask
                {
                    Name = "Clear cache",
                    Seconds = 600,
                    Type = "RufaPoint.Services.Caching.ClearCacheTask, RufaPoint.Services",
                    Enabled = false,
                    StopOnError = false,
                },
                new ScheduleTask
                {
                    ...
                    //60 minutes
                    Seconds = 3600,
                    Type = "RufaPoint.Services.Logging.ClearLogTask, RufaPoint.Services",
                    Enabled = false,
                    StopOnError = false,
                },
                new ScheduleTask
                {
                    ...
                    //60 minutes
                    Seconds = 3600,
                    Type = "RufaPoint.Services.Directory.UpdateExchangeRateTask, RufaPoint.Services",
                    Enabled = true,
                    StopOnError = false,
                },
            };
