...
namespace RufaPoint.Services.Orders
{
    /// <summary>
    ...
    public partial class CheckoutAttributeService : ICheckoutAttributeService
    {
        ...
        /// </remarks>
        private const string CHECKOUTATTRIBUTES_ALL_KEY = "RufaPoint.checkoutattribute.all-{0}-{1}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        private const string CHECKOUTATTRIBUTES_BY_ID_KEY = "RufaPoint.checkoutattribute.id-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        /// {0} : checkout attribute ID
        /// </remarks>
        private const string CHECKOUTATTRIBUTEVALUES_ALL_KEY = "RufaPoint.checkoutattributevalue.all-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        private const string CHECKOUTATTRIBUTEVALUES_BY_ID_KEY = "RufaPoint.checkoutattributevalue.id-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string CHECKOUTATTRIBUTES_PATTERN_KEY = "RufaPoint.checkoutattribute.";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string CHECKOUTATTRIBUTEVALUES_PATTERN_KEY = "RufaPoint.checkoutattributevalue.";
