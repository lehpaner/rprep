...
namespace RufaPoint.Core.Tests.Infrastructure.DependencyManagement
{
    ...
    public class AutofacTests
    {
        ...
        [Fact/*(Description = "Exercises a problem in a previous version, to make sure older Autofac.dll isn't picked up")*/]
